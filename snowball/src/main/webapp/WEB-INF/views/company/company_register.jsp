...
<div class="container center-contents">
   <div class="row">
      <form  method="post" class="form-signin">
         ...
         <div class="form-group">
         <label >파견지 주소</label>
         <input name="company_addr" class="form-control">
         </div>
         
         <div class="form-group">
            <label >파견 사원명</label>
            <input name="company_man" class="form-control">
         </div>
         
         <div class="form-group">
            <label >계약 시작 일시</label>
            <input name="company_partner_start" class="form-control">
         </div>
         
         <div class="form-group">
            <label >계약 종료 일시</label>
            <input name="company_partner_end" class="form-control">
         </div>
